package com.HudLuca.SimulacaoSeguros.service.validacao.utils;

public class BR {

    /**
     * FONTE: https://github.com/wendelanchieta/companheirosautocenter
     */
     ...
     * @return
     */
    public static boolean isValidoCPF(final String ssn) {
     ...
     * @return
     */
    public static boolean isValidoCNPJ(final String tin) {
